<?php 
    ...
    if(isset($_POST['update']))
    {
        ...
        $sqlUpdate = "UPDATE tb_folder SET avaliador='$avaliador', area='$area', mes_aval='$mes_aval', ano_aval='$ano_aval', reclamante='$reclamante', reclamada='$reclamada', ramo='$ramo', cargo='$cargo', periodo='$periodo', comarca='$comarca', salario='$salario', tipo_acao='$tipo_acao', obs='$obs'
